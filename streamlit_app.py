...
const EnhancedTradingSimulator = () => {
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg max-w-7xl mx-auto">
      <h2 className="text-xl font-bold mb-2">Advanced Market Prediction Simulator</h2>
      
      {roundEnded && (
        <div className="w-full bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-4">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold">Prediction Round Complete!</p>
              <p>
      ...
      <div className="w-full bg-gray-100 p-4 rounded-lg mb-4">
        <div className="flex justify-between mb-4">
          ...
          <div className="flex items-center">
            <span className="px-3 py-1 bg-gray-700 text-white rounded-full text-xs font-bold mr-2">
              {marketLabel}
            </span>
            <span className="text-sm mr-2">Day: {day}/{data.length}</span>
        ...
        <div className="flex mt-4 justify-between items-center">
          ...
          {autoTraining && (
            <div className="px-3 py-1 bg-purple-600 text-white rounded-full text-xs animate-pulse">
      ...
      <div className="mt-4 text-sm text-gray-600">
        <p>
          <span className="font-bold">Prediction Approach:</span> Each AI predicts High of Day (HOD) and Low of Day (LOD) for the coming market days.
        </p>
        <p>
          <span className="font-bold">Learning Method:</span> Reinforcement learning is used to reward accurate predictions and improve future forecasts.
        </p>
        <p>
          <span className="font-bold">Usage:</span> After training, select the best performing AI to use for real market predictions.
        </p>
      </div>
    </div>
  );
...
export default EnhancedTradingSimulator;
